...
export default function CompletarPerfil({ navigation }) {
  ...
  const profession_id = useSelector(state => state.auth.preferences.profession?.name);
  ...
  const datosList = [
    ...
    { value: 'Occupation', key: profession_id ? profession_id : 'Needs completing' },
  ];
  ...
  return (
    <ScrollView style={styles.container}>
      <Icon
        name="arrow-left"
        size={20}
        style={{ color: colors.secondary, padding: 10, marginLeft: 10 }}
        ...
        <View style={{ justifyContent: 'space-between', padding: '2%' }}>
          <View style={{ flexDirection: 'row', width: '100%' }}>
            ...
            <View style={{ alignItems: 'center', justifyContent: 'center' }}>
              ...
              <Text style={{ marginTop: '-40%', color: colors.secondary }}>{Math.round(progress * 100)}%</Text>
            </View>
          ...
          <Text style={{ width: 200, padding: 10, color: 'white' }}>
            Get more visibility and reach more calls with a more complete profile
          </Text>
        ...
        <ScrollView horizontal={true} style={styles.scroll}>
          <View style={[styles.slideContainer, styles.slide]}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Datos')}>
              <Text style={[style.subTitulo, { color: '#45AACA', marginTop: '7%' }]}>
                Complete
              </Text>
            </TouchableOpacity>
          </View>
          ...
          <View style={[styles.slideContainer, styles.slide]}>
            ...
            <TouchableOpacity onPress={() => navigation.navigate('Intereses')}>
              <Text style={[style.subTitulo, { color: '#45AACA', marginTop: '30%' }]}>
                Complete
              </Text>
            </TouchableOpacity>
          </View>
